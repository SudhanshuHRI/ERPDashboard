    ...
    return (
        <div>
            <Breadcrumb>
                ...
                <Breadcrumb.Item active>Catogary Master</Breadcrumb.Item>
            </Breadcrumb>
            <Row>
                <Col>
                    <Card>
                            ...
                            <div>
                                ...
                                <Form>
                                    <FormGroup>
                                        <Row>
                                            <Col sm={6}>
                                                <Label>Catogary Name</Label><FaStarOfLife className='mandStar' />
                                                <Input type='text' />
                                            </Col>
                                            <Col sm={6}>
                                            </Col>
                                ...
                                <Button onClick={() => alert("added")}>Add Catogary</Button>
                            </div>
                        </CardBody>
                    </Card>
                    <Card >
